...
// REMOVED: Legacy e-commerce orders - replaced by quotations → salesOrders → jobOrders workflow

// REMOVED: Legacy e-commerce features (cart, wishlist, reviews) - not needed for B2B manufacturing
